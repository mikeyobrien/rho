import { AppLifecycle, type AppView } from "./app-lifecycle.js";
...
const webContainer = document.getElementById(
	"web-container",
) as HTMLDivElement | null;
const webFrame = document.getElementById(
	"web-frame",
) as HTMLIFrameElement | null;
const switchProfileBtn = document.getElementById(
	"btn-switch-profile",
) as HTMLButtonElement | null;

// Optional Live Mode UI elements (picker + embedded web container)
const liveModeToggleBtn = document.getElementById(
	"btn-live-mode",
) as HTMLButtonElement | null;
const liveModeStatusEl = document.getElementById(
	"live-mode-status",
) as HTMLSpanElement | null;
const liveModeToggleBtnPicker = document.getElementById(
	"btn-live-mode-picker",
) as HTMLButtonElement | null;
...
function updateLiveModeUI(): void {
	...
	const statusEls = [liveModeStatusEl, liveModeStatusElPicker].filter(
		Boolean,
	) as HTMLSpanElement[];
