...
const liveModeStatusElPicker = document.getElementById('live-mode-status-picker');
// Form elements
...
function updateLaunchButton() {
    const selectedExists = !!selectedProfileId && currentProfiles.some((p) => p.id === selectedProfileId);
...
function updateLiveModeUI() {
    ...
    const toggleBtns = [liveModeToggleBtn, liveModeToggleBtnPicker].filter(Boolean);
